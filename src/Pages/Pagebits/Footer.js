...
function Footer() {
  return (
    ...
    <div className="container p-4">
      <div className="row">
        <div className="col-lg-6 col-md-12 mb-4 mb-md-0">
          <h5 className="text-uppercase Font2 FBR  MFont TC6">Contact</h5>
  
          <p className = "Font3 FB SFont">
        ...
        <div className="col-lg-6 col-md-12 mb-4 mb-md-0">
          <h5 className="text-uppercase Font2 FBR TC6 MFont">Thoughts?</h5>
  
          <p className = "Font3 SFont FB">
    ...
    <div className="text-center p-3 Font2 TC5 SFont" >
